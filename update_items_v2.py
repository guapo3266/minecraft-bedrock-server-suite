...
update_json_file("behavior_packs/guardian_robot_BP/items/guardian_activator.json", modify_activator)
update_json_file("behavior_packs/guardian_robot_BP/items/guardian_controller.json", modify_controller)
...
update_json_file("behavior_packs/guardian_robot_BP/manifest.json", modify_bp_manifest)
...
update_json_file("resource_packs/guardian_robot_RP/manifest.json", modify_rp_manifest)
...
update_json_file("worlds/Bedrock level/world_behavior_packs.json", modify_world_bp)
...
update_json_file("worlds/Bedrock level/world_resource_packs.json", modify_world_rp)
