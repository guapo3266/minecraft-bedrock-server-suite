...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    const bgVec4 = new THREE.Vector4(0.03, 0.04, 0.07, 1.0);
...
`;
    ...
    void main(){
    vec2 vel = texture2D(velocity, uv).xy;
    float lenv = clamp(length(vel) * 2.8 + 0.15, 0.05, 1.0);
    vec3 c = texture2D(palette, vec2(lenv, 0.5)).rgb;
    vec3 outRGB = mix(bgColor.rgb, c, lenv * 0.85);
    float outA = 1.0;
...
`;
    ...
    // IntersectionObserver removed to prevent erroneous pauses during scroll
